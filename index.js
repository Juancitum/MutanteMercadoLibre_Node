...
/* back de lo hecho hasta aca, aun no funcional
...
var firebaseConfig = {
	apiKey: "AIzaSyCt2Je8G9Ntm72n0jKGUSey5k0q8XauiaY",
  authDomain: "mutantmercadolibre.firebaseapp.com",
  databaseURL: "https://mutantmercadolibre.firebaseio.com",
  projectId: "mutantmercadolibre",
  storageBucket: "mutantmercadolibre.appspot.com",
  messagingSenderId: "317486873719",
  appId: "1:317486873719:web:f22ea420426fd7b50a5a72",
  measurementId: "G-LNG3Q0RWYR"
  };
...
// funcion valida string mutante json
let validaMutante = function (mutanteString) {
    var matriz =  new Array (mutanteString.length);
    var matrizTraspuesta = new Array (mutanteString.length);
    var cadena = null;
  ...
  // Funcion post con llamada a validacion
...
app.post('/mutant', (req, res) => {
   ...
   var retornoDataBase= db.ref().push();
       if(retorno == true){
...
let addDoc = db.collection('cities').add({
  ...
  console.log('Added document with ID: ', ref.id);
        ...
        res.send("Usted es Mutante yes" + ref.id);
       }else{
        res.status(403).send("Usted NO es Mutante");
       }
    res.send ("Envio cadena: " + myArrStr);
